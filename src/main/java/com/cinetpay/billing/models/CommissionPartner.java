...
public class CommissionPartner {
    ...
    @Column(columnDefinition = "decimal(12,2) default 0", name = "commission_vendor_fixe", nullable = false)
    private Double commissionVendorFixe;
    
    @Column(columnDefinition = "decimal(5,4) default 0", name = "commission_vendor_variable", nullable = false)
    private Double commissionVendorVariable;
